...
Monitorea los clicks del ratón y muestra qué atajo de teclado
...
class Atajator:
    def __init__(self):
        ...
        # ── tkinter (hilo principal) ───────────────────────────────────
        self.root = tk.Tk()
        self.root.withdraw()          # ventana principal invisible
